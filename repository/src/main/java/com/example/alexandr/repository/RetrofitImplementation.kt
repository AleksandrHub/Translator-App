...
import com.example.alexandr.repository.api.ApiService
import com.example.alexandr.repository.api.BaseInterceptor
...
class RetrofitImplementation :
    com.example.alexandr.repository.DataSource<List<com.example.alexandr.model.SearchResult>> {
