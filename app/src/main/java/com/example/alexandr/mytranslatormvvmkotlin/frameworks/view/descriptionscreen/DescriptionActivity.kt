package com.example.alexandr.mytranslatormvvmkotlin.frameworks.view.descriptionscreen
...
import com.example.alexandr.utils.ui.AlertDialogFragment
...
class DescriptionActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        if (imageLink.isNullOrBlank()) {
            ...
            useGlideToLoadPhoto(description_imageview as ImageView, imageLink)
        }
    }
